...
// ══════════════════════════════════════════════════════════════
// SETTINGS HELPER — reads from Supabase settings table
// ══════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════
// BREVO EMAIL  — key read from Supabase settings table (admin panel)
// ══════════════════════════════════════════════════════════════
async function sendEmail(to, toName, subject, htmlContent) {
  const apiKey    = await getSetting('BREVO_API_KEY');
  const rawSender = await getSetting('BREVO_SENDER_EMAIL') || 'GoodLife Fitness <noreply@goodlife.com>';

  if (!apiKey) {
    console.warn('⚠️  BREVO_API_KEY not set in admin panel — email skipped');
    return { success: false, error: 'BREVO_API_KEY not configured in admin panel' };
  }
...
// ══════════════════════════════════════════════════════════════
// SETTINGS API  (used by admin panel to save/read keys)
// ══════════════════════════════════════════════════════════════
